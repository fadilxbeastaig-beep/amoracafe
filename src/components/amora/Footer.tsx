      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col items-center text-center space-y-6">
          <div className="flex items-center gap-3">
            ...
            <span className="font-display text-2xl font-bold text-foreground">Amora Specialty Café</span>
          </div>
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              className="p-3 rounded-full glass-card hover:bg-primary/10 hover:border-primary/30 transition-all"
          ...
          <div className="pt-8 border-t border-border w-full">
            <p className="text-sm text-muted-foreground flex items-center justify-center gap-1">
              © 2024 Amora Specialty Café. Crafted with <Heart className="h-3.5 w-3.5 text-destructive fill-destructive" /> in Abu Dhabi
            </p>
          </div>
        </div>
      </div>
