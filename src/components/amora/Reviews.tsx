...
const reviews = [
  ...
  {
    text: "I tried a Cortado with Ethiopian beans and it was perfect — made with care and passion.",
    author: "Layla R.",
  },
];
    ...
    <section id="reviews" className="py-28 lg:py-40">
      ...
      >
        <div className="text-center mb-16">
          <p className="text-xs font-medium text-primary tracking-[0.3em] uppercase mb-4">Reviews</p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {reviews.map((r) => (
            <div key={r.author} className="text-center space-y-5">
